...
class App extends React.Component {
    ...
    renderMethodDropDown = () => {
        return this.renderDropDown('Method', <MethodDropdown onChange={this.handleMethodChange}/>)
    }
    ...
    handleMethodChange = (value) => {
        ...
        if (value === "Experimental") {
            newDisplay = [ this.renderMethodDropDown(), 
                this.renderTechniqueDropDown(<ExperimentalTechniqueDropdown onChange={this.handleTechniqueChange}/>)
            ]
        } else if (value === "Calculation") {
            newDisplay= [ this.renderMethodDropDown(), 
                this.renderTechniqueDropDown(<CalculationTechniqueDropdown onChange={this.handleTechniqueChange}/>)
            ]
        } else {
            newDisplay = [ this.renderMethodDropDown() ]
        }
    ...
    handleTechniqueChange = (value) => {
        ...
        if (value === "Spectroscopy") {
            newDisplay.push(this.renderTypeDropDown(<SpectroscopyTypeDropdown onChange={this.handleTypeChange}/>))
        } else if (value === "Atomistic (Quantum)") {
            newDisplay.push(this.renderTypeDropDown(<AtomisticQuantumTypeDropdown onChange={this.handleTypeChange}/>))
        } else if (value === "") {
    ...
    handleTypeChange = (value) => {
        console.log(value)
        var newDisplay = this.state.display;
        newDisplay.push(<div> <MainTabs/> </div>)
        this.setState({
            display: newDisplay
        })
    }

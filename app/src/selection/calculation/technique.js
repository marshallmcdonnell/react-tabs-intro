...
const calculationTechniqueOptions = [
    { key: 'Atomistic (Quantum)', text: 'Atomistic (Quantum)', value: 'Atomistic (Quantum)' },
    { key: 'Atomistic (Classical)', text: 'Atomistic (Classical)', value: 'Atomistic (Classical)' },
...
export function CalculationTechniqueDropdown(props) {
    return (
        <Dropdown 
            ...
            selection onChange={(evt, data) => {props.onChange(data.value)} }
        /> 
    )
};
